...
> 本文档是 [Dino Vault Writeup](ACSC2026Qualification_Dino_Vault.md) 的补充知识点，重点解释 RSA 中常见的模运算规则、模逆元、同余方程求解，以及为什么 $d = e^{-1} \bmod \varphi(n)$ 不是普通倒数。
...
### 4.2 例子：解 $14x \equiv 30 \pmod{100}$
...
因为 $2 \mid 30$，所以有解，而且有 2 个模 100 意义下的解。
...
由于 $\varphi(n)$ 通常非常大，这个 $d$ 往往也是一个很大的整数。
