...
-   :material-lock:{ .lg .middle } __Crypto__
    ...
    [:octicons-arrow-right-24: 20 篇文章](Cryptography(密码学)/index.md)
...
-   :material-puzzle:{ .lg .middle } __Misc & PPC__
    ...
    [:octicons-arrow-right-24: 6 + 1 篇文章](Misc(杂项)/index.md)
...
| [**CPCTF**](events/CPCTF/index.md) | 2026.04.17-04.19 | Crypto / Reverse / Misc / Pwn | 7 | :material-check-circle: 已归档 |
